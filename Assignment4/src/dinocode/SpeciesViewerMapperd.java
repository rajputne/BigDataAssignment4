...
public class SpeciesViewerMapperd extends MapReduceBase implements Mapper<WritableComparable, Writable, Text, Text> {
    ...
    public void map(WritableComparable key, Writable value,
        ...
        boolean allLetters = pagetitle.chars().allMatch(Character::isLetter);
        if (allLetters && pagetitle.length()>2) {
